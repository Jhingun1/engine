...
vars = {
  ...
  'dart_revision': 'ce5fb94014d4859ace1d1732ac7c51599010a6ea',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/dartdoc':
   Var('dart_git') + '/dartdoc.git@v0.30.1',
     ...
     'packages': [
       {
        ...
        'version': 'oHa-OkzSy5Z_u3IG7gTXJFzijM11niA7tRjJpQu8dBcC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'Bmq1mpid-GcY6qBE23OaJ0hQ3UND90W0QIViirMAusAC'
       }
     ],
